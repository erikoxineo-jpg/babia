...
export function AppointmentCard({
  ...
  return (
    <button
      ...
      className={`absolute left-1 right-1 rounded-xl border-l-4 px-2 py-1 text-left cursor-pointer overflow-hidden transition-opacity hover:opacity-90 z-10 ${STATUS_COLORS[appointment.status]}`}
